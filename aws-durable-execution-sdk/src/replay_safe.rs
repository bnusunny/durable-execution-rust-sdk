...
mod tests {
    ...
    fn test_uuid_to_string_format() {
        ...
        for (i, c) in uuid_string.chars().enumerate() {
            if i == 8 || i == 13 || i == 18 || i == 23 {
                ...
                assert!(c.is_ascii_hexdigit(), "Character at position {} should be hex digit", i);
            }
        }
    }
    ...
    fn test_uuid_uniqueness_across_many_operations() {
        ...
        for i in 0..1000 {
            ...
            assert!(uuids.insert(uuid), "UUID collision detected at iteration {}", i);
        }
    }
    ...
    fn test_uuid_uniqueness_across_many_seeds() {
        ...
        for seed in 0..1000u64 {
            ...
            assert!(uuids.insert(uuid), "UUID collision detected at seed {}", seed);
        }
    }
