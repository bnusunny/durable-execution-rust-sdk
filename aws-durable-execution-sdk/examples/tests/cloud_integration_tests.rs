...
cloud_test!(cloud_step_error_determinism);
...
cloud_test!(cloud_wait_for_condition_basic);
...
cloud_test!(cloud_parallel_with_wait);

// ============================================================================
// Promise Combinators
// ============================================================================
cloud_test!(cloud_promise_all);
cloud_test!(cloud_promise_all_settled);
cloud_test!(cloud_promise_any);
cloud_test!(cloud_promise_race);
...
cloud_test!(cloud_child_context_large_data);
cloud_test!(cloud_child_context_checkpoint_size_limit);
...
cloud_test!(cloud_large_payload);
