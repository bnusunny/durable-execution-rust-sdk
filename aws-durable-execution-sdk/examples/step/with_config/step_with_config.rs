...
#[durable_execution]
pub async fn handler(_event: serde_json::Value, ctx: DurableContext) -> Result<PaymentResult, DurableError> {
    ...
    let payment: PaymentResult = ctx
        .step_named("charge_payment", |_step_ctx| {
    ...
    let _logged: bool = ctx
        .step_named("log_transaction", |_step_ctx| {
